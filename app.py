...
def process_image(image_bytes, radius, debug=False):
    ...
    # Otsu's Method handles both Light and Dark backgrounds automatically
    ...
    # GEOMETRY AUDIT: Identifying the four-pointed star 'Twin'
    ...
    for cnt in contours:
        ...
        if 200 < area < 4500:
            ...
            # Target the star's specific solidity footprint
...
if check_password():
    ...
    with st.sidebar:
        ...
        debug_mode = st.checkbox("🐞 Debug Mode: Show Mask", help="See what the AI is targeting.")

    uploaded_files = st.file_uploader("Upload campaign ads", type=['jpg', 'jpeg', 'png'], accept_multiple_files=True)
