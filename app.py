...
# --- 2. FORENSIC PROCESSING (Otsu Logic) ---
def process_image(img_bytes, radius, debug=False):
    ...
    # Otsu's method handles light/dark backgrounds automatically
...
# --- 3. INTERFACE ---
st.set_page_config(page_title="PhD Eraser", layout="wide")
